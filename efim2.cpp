        ...
        for (int item : primary)
        {
            ...
            for (const auto &entry : transactions)
            {
                ...
                if (std::find(trans.keys.begin(), trans.keys.end(), item) != trans.keys.end())
                {
                    ...
                    // // print current transaction for debugging
                    // std::cout << "Transaction: ";
                    // for (int i = 0; i < trans.keys.size(); i++)
                    // {
                    //     std::cout << trans.keys[i] << ":" << trans.vals[i] << " ";
                    // }
                    // std::cout << std::endl;
            ...
            // // print primary for debugging and nextPrimary
            // std::cout << "Primary: " << std::endl;
            // for (const auto &p : nextPrimary)
            // {
            //     std::cout << p << " ";
            // }
            // std::cout << std::endl;

            // // print secondary for debugging and nextSecondary
            // std::cout << "Secondary: " << std::endl;
            // for (const auto &s : nextSecondary)
            // {
            //     std::cout << s << " ";
            // }
            // std::cout << std::endl;
